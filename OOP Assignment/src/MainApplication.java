...
import javax.swing.table.DefaultTableModel; // Needed for DefaultTableModel instantiation
...
public class MainApplication extends JFrame {
    ...
    private void initComponents() {
        ...
        // For AssignDriversPanel, controllers might need to be created with null TableModels
        // if they don't directly manage a table on that panel.
        assignDriversPanel = new AssignDriversPanel(
                new ShipmentController(shipmentDAO, null), // Pass null for table model if not managing a table directly
                new DeliveryPersonnelController(personnelDAO, null), // Pass null for table model
                shipmentDAO,
                personnelDAO
        );
        tabbedPane.addTab("Assign Drivers", assignDriversPanel);

        reportPanel = new ReportPanel(new ReportController(reportDAO, null)); // TableModel set inside panel
