...
import view.controller.NotificationController;
import DAO.ShipmentDAO;
import Model.Shipment;
import view.Model.Notification;
...
public class CustomerNotificationsPanel extends JPanel {
    ...
    public void refreshNotificationTable() {
        ...
        try {
            List<Notification> allNotifications = notificationController.getNotificationDAO().getAllNotifications();
